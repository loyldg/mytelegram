...
public class AcksDataReceivedEventEventDataSerializer : IEventDataSerializer<AcksDataReceivedEvent>, ITransientDependency
{
    ...
    public void Serialize(IBufferWriter<byte> writer, AcksDataReceivedEvent data)
    {
        ...
        writer.Write(data.InvokeAfterMsgId);
    }
    ...
    public AcksDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        var invokeAfterMsgId = buffer.ReadInt64();
        ...
        return new AcksDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class DataReceivedEventEventDataSerializer : IEventDataSerializer<DataReceivedEvent>, ITransientDependency
{
    ...
    public DataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new DataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class DownloadDataReceivedEventEventDataSerializer : IEventDataSerializer<DownloadDataReceivedEvent>, ITransientDependency
{
    ...
    public DownloadDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new DownloadDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class MessengerCommandDataReceivedEventEventDataSerializer : IEventDataSerializer<MessengerCommandDataReceivedEvent>, ITransientDependency
{
    ...
    public MessengerCommandDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new MessengerCommandDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class MessengerDataReceivedEventEventDataSerializer : IEventDataSerializer<MessengerDataReceivedEvent>, ITransientDependency
{
    ...
    public MessengerDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new MessengerDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class MessengerQueryDataReceivedEventEventDataSerializer : IEventDataSerializer<MessengerQueryDataReceivedEvent>, ITransientDependency
{
    ...
    public MessengerQueryDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new MessengerQueryDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class StickerDataReceivedEventEventDataSerializer : IEventDataSerializer<StickerDataReceivedEvent>, ITransientDependency
{
    ...
    public StickerDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new StickerDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class UpdatesDataReceivedEventEventDataSerializer : IEventDataSerializer<UpdatesDataReceivedEvent>, ITransientDependency
{
    ...
    public UpdatesDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new UpdatesDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
...
public class UploadDataReceivedEventEventDataSerializer : IEventDataSerializer<UploadDataReceivedEvent>, ITransientDependency
{
    ...
    public UploadDataReceivedEvent Deserialize(ReadOnlyMemory<byte> buffer)
    {
        ...
        return new UploadDataReceivedEvent(connectionId, connectionType, requestId, objectId, userId, reqMsgId, seqNumber, authKeyId, permAuthKeyId, data, layer, date, deviceType, clientIp, sessionId, accessHashKeyId, invokeAfterMsgId)
        {
            MemoryOwner = owner
        };
    }
