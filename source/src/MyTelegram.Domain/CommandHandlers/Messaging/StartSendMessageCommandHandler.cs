...
public class StartSendMessageCommandHandler : CommandHandler<MessageAggregate, MessageId, StartSendMessageCommand>
{
    ...
    {
        aggregate.StartSendMessage(command.RequestInfo, command.OutMessageItem, command.ClearDraft, command.GroupItemCount, command.ForwardFromLinkedChannel, command.CorrelationId);
