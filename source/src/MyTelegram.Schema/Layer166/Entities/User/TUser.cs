...
{
    public uint ConstructorId => 0xeb602f25;
    ///<summary>
    ...
    public void ComputeFlag()
    {
        ...
        if (/*Color != 0 && */Color.HasValue) { Flags2[7] = true; }
        if (/*BackgroundEmojiId != 0 &&*/ BackgroundEmojiId.HasValue) { Flags2[6] = true; }
    }
    ...
    public void Serialize(IBufferWriter<byte> writer)
    {
        ...
        if (Flags2[7]) { writer.Write(Color.Value); }
        if (Flags2[6]) { writer.Write(BackgroundEmojiId.Value); }
    }
    ...
    public void Deserialize(ref SequenceReader<byte> reader)
    {
        ...
        if (Flags2[7]) { Color = reader.ReadInt32(); }
        if (Flags2[6]) { BackgroundEmojiId = reader.ReadInt64(); }
    }
}