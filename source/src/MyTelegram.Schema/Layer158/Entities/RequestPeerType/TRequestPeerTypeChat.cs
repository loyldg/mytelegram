...
///<summary>
///See <a href="https://core.telegram.org/constructor/requestPeerTypeChat" />
///</summary>
[TlObject(0xc9f06e1b)]
public sealed class TRequestPeerTypeChat : IRequestPeerType
{
    ...
    public void ComputeFlag()
    {
        ...
        if (BotParticipant) { Flags[5] = true; }
        if (HasUsername !=null) { Flags[3] = true; }
        if (Forum !=null) { Flags[4] = true; }
    ...
    public void Serialize(BinaryWriter bw)
    {
        ...
        if (Flags[4]) { bw.Serialize(Forum.Value); }
    ...
    public void Deserialize(BinaryReader br)
    {
        ...
        if (Flags[5]) { BotParticipant = true; }
        if (Flags[3]) { HasUsername = br.Deserialize<bool>(); }
        if (Flags[4]) { Forum = br.Deserialize<bool>(); }
