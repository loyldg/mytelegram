...
{
    public uint ConstructorId => 0xfc25b828;
    ...
    public void Serialize(BinaryWriter bw)
    {
        ...
        if (Flags[7]) { bw.Serialize(SponsorInfo); }
        if (Flags[8]) { bw.Serialize(AdditionalInfo); }
    }
    ...
    public void Deserialize(BinaryReader br)
    {
        ...
        if (Flags[7]) { SponsorInfo = br.Deserialize<string>(); }
        if (Flags[8]) { AdditionalInfo = br.Deserialize<string>(); }
    }
}