...
/// <para><c>400 TOKEN_EMPTY The specified token is empty.</c></para>
/// <para><c>400 TOKEN_INVALID The provided token is invalid.</c></para>
/// <para><c>400 TOKEN_TYPE_INVALID The specified token type is invalid.</c></para>
/// <para><c>400 WEBPUSH_AUTH_INVALID The specified web push authentication secret is invalid.</c></para>
/// <para><c>400 WEBPUSH_KEY_INVALID The specified web push elliptic curve Diffie-Hellman public key is invalid.</c></para>
/// <para><c>400 WEBPUSH_TOKEN_INVALID The specified web push token is invalid. </c></para>
/// <para>See <a href="https://corefork.telegram.org/method/account.registerDevice" /></para>
/// </summary>
/// <remarks>
/// Access: [User ✔] [Bot ✖] [Anonymous ✖]
/// </remarks>
[TlObject(0xec86017a)]
public sealed partial class RequestRegisterDevice : IRequest<IBool>
{
