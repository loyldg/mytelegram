...
/// <para><c>400 ARTICLE_TITLE_EMPTY The title of the article is empty.</c></para>
/// <para><c>400 AUDIO_CONTENT_URL_EMPTY The remote URL specified in the content field is empty.</c></para>
/// <para><c>400 AUDIO_TITLE_EMPTY An empty audio title was provided.</c></para>
...
/// <para><c>400 PHOTO_CONTENT_TYPE_INVALID Photo mime-type invalid.</c></para>
/// <para><c>400 PHOTO_CONTENT_URL_EMPTY Photo URL invalid.</c></para>
/// <para><c>400 PHOTO_INVALID Photo invalid.</c></para>
/// <para><c>400 PHOTO_THUMB_URL_EMPTY Photo thumbnail URL is empty.</c></para>
...
/// <para><c>400 RESULTS_TOO_MUCH Too many results were provided.</c></para>
/// <para><c>400 RESULT_ID_DUPLICATE You provided a duplicate result ID.</c></para>
/// <para><c>400 RESULT_ID_INVALID One of the specified result IDs is invalid.</c></para>
/// <para><c>400 RESULT_TYPE_INVALID Result type invalid.</c></para>
/// <para><c>400 SEND_MESSAGE_MEDIA_INVALID Invalid media provided.</c></para>
/// <para><c>400 SEND_MESSAGE_TYPE_INVALID The message type is invalid.</c></para>
...
/// <para><c>400 STICKER_DOCUMENT_INVALID The specified sticker document is invalid.</c></para>
/// <para><c>400 SWITCH_PM_TEXT_EMPTY The switch_pm.text field was empty.</c></para>
/// <para><c>400 SWITCH_WEBVIEW_URL_INVALID The URL specified in switch_webview.url is invalid!</c></para>
...
/// <para><c>400 VIDEO_TITLE_EMPTY The specified video title is empty.</c></para>
/// <para><c>400 WEBDOCUMENT_INVALID Invalid webdocument URL provided.</c></para>
/// <para><c>400 WEBDOCUMENT_MIME_INVALID Invalid webdocument mime type provided.</c></para>
/// <para><c>400 WEBDOCUMENT_SIZE_TOO_BIG Webdocument is too big!</c></para>
/// <para><c>400 WEBDOCUMENT_URL_EMPTY The passed web document URL is empty.</c></para>
/// <para><c>400 WEBDOCUMENT_URL_INVALID The specified webdocument URL is invalid. </c></para>
/// <para>See <a href="https://corefork.telegram.org/method/messages.setInlineBotResults" /></para>
/// </summary>
/// <remarks>
/// Access: [User ✖] [Bot ✔] [Anonymous ✖]
/// </remarks>
[TlObject(0xbb12a419)]
public sealed partial class RequestSetInlineBotResults : IRequest<IBool>
{
