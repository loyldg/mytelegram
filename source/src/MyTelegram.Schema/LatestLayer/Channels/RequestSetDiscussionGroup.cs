...
/// <para><c>400 BROADCAST_ID_INVALID Broadcast ID invalid.</c></para>
...
/// <para><c>400 LINK_NOT_MODIFIED Discussion link not modified.</c></para>
/// <para><c>400 MEGAGROUP_ID_INVALID Invalid supergroup ID.</c></para>
/// <para><c>400 MEGAGROUP_PREHISTORY_HIDDEN Group with hidden history for new members can't be set as discussion groups. </c></para>
/// <para>See <a href="https://corefork.telegram.org/method/channels.setDiscussionGroup" /></para>
/// </summary>
/// <remarks>
/// Access: [User ✔] [Bot ✖] [Anonymous ✖]
/// </remarks>
[TlObject(0x40582bb2)]
public sealed partial class RequestSetDiscussionGroup : IRequest<IBool>
{
