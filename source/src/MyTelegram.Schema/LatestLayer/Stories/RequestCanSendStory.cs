...
/// <para><c>400 STORY_SEND_FLOOD_MONTHLY_%d You've hit the monthly story limit as specified by the <a href="https://corefork.telegram.org/api/config#stories-sent-monthly-limit-default"><code>stories_sent_monthly_limit_*</code> client configuration parameters</a>: wait %d seconds before posting a new story.</c></para>
/// <para><c>400 STORY_SEND_FLOOD_WEEKLY_%d You've hit the weekly story limit as specified by the <a href="https://corefork.telegram.org/api/config#stories-sent-weekly-limit-default"><code>stories_sent_weekly_limit_*</code> client configuration parameters</a>: wait for %d seconds before posting a new story. </c></para>
/// <para>See <a href="https://corefork.telegram.org/method/stories.canSendStory" /></para>
/// </summary>
/// <remarks>
/// Access: [User ✔] [Bot ✖] [Anonymous ✖]
/// </remarks>
[TlObject(0x30eb63f0)]
public sealed partial class RequestCanSendStory : IRequest<MyTelegram.Schema.Stories.ICanSendStoryCount>
{
