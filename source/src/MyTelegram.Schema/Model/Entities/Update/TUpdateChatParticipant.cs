...
///<summary>
///See <a href="https://core.telegram.org/constructor/updateChatParticipant" />
///</summary>
[TlObject(0xd087663a)]
public class TUpdateChatParticipant : IUpdate
{
    ...
    public void Deserialize(BinaryReader br)
    {
        ...
        UserId = br.ReadInt64();
        if (Flags[0]) { PrevParticipant = br.Deserialize<MyTelegram.Schema.IChatParticipant>(); }
        if (Flags[1]) { NewParticipant = br.Deserialize<MyTelegram.Schema.IChatParticipant>(); }
