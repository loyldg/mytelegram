...
//        _length = length == 0 ? bytes.Length : length;
//    }
...
//    {
//        if (_showOffset) _sb.Append("Offset(h)  ");
//        for (var i = 0; i < _bytesPerLine; i++)
//        {
//            _sb.Append($"{i & 0xFF:D2}");
//            if (i + 1 < _bytesPerLine) _sb.Append(' ');
//        }
...
//                if (_index > 0)
//                {
//                    if (_showAscii) WriteAscii();
//                    _sb.AppendLine();
//                }

//                if (_showOffset) WriteOffset();
//            }

//            WriteByte();
//            if (_index % _bytesPerLine != 0 && _index < _length) _sb.Append(' ');
//        }
...
//        _sb.Append("   ");
//        for (var i = 0; i < length; i++) _sb.Append(Translate(_bytes[backtrack + i]));
//    }
