...
//public class SystemTextJsonSingleValueObjectConverter<T> : SystemTextJsonSingleValueObjectConverter<T, string>
//    where T : SingleValueObject<string>
//{
        ...
        where TValue : IComparable
{
    ...
    public override T Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        var value = JsonSerializer.Deserialize(ref reader, typeof(TValue), options);
