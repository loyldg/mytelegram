...
public abstract class HiLoValueGenerator<TValue> : ValueGenerator<TValue>
{
    ...
    protected abstract long GetNewLowValue(IdType idType,
        long key);
    ...
    protected virtual Task<long> GetNewLowValueAsync(IdType idType,
        long key,
        CancellationToken cancellationToken = default)
    {
        return Task.FromResult(GetNewLowValue(idType, key));
    }
