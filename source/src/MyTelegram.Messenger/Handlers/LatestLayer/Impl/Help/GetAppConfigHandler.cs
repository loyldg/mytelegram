        ...
        MyTelegram.Schema.Help.RequestGetAppConfig obj)
    {
        IJSONValue r = new TJsonObject
        {
            Value = new TVector<IJSONObjectValue>(
              ...
              //},
              new TJsonObjectValue()
              { Key = "stickers_emoji_suggest_only_api", Value = new TJsonBool { Value = false } },
              new TJsonObjectValue() { Key = "stickers_emoji_cache_time", Value = new TJsonNumber { Value = 86400 } },
              new TJsonObjectValue()
              { Key = "groupcall_video_participants_max", Value = new TJsonNumber { Value = 1000 } },
              ...
              new TJsonObjectValue { Key = "autoarchive_setting_available", Value = new TJsonBool { Value = false } },
              new TJsonObjectValue
              {
              ...
              new TJsonObjectValue
              {
                  Key = "reactions_user_max_default",
                  Value = new TJsonNumber { Value = 1 }
              },
              new TJsonObjectValue
              {
                  Key = "reactions_user_max_premium",
        ...
        return Task.FromResult<MyTelegram.Schema.Help.IAppConfig>(new TAppConfig
        {
            Config = r,
            Hash = 0
        });
