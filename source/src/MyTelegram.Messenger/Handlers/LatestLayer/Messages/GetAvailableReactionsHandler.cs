...
internal sealed class GetAvailableReactionsHandler : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestGetAvailableReactions, MyTelegram.Schema.Messages.IAvailableReactions>
{
    protected override Task<MyTelegram.Schema.Messages.IAvailableReactions> HandleCoreAsync(IRequestInput input, MyTelegram.Schema.Messages.RequestGetAvailableReactions obj)
    {
        ...
        var thumbsUp = new TAvailableReaction
        {
            ...
            Inactive = false,
            Premium = false,
            StaticIcon = new TDocumentEmpty
            {
                Id = 5044395559658455501
            },
            AppearAnimation = new TDocumentEmpty
            {
                Id = 5044395559658455501
            },
            SelectAnimation = new TDocumentEmpty
            {
                Id = 5044395559658455501
            },
            ActivateAnimation = new TDocumentEmpty
            {
                Id = 5044395559658455501
            },
            EffectAnimation = new TDocumentEmpty
            {
                Id = 5044395559658455501
            },
