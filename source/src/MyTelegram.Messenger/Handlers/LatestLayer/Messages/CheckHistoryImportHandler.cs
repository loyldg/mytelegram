...
{
    protected override Task<MyTelegram.Schema.Messages.IHistoryImportParsed> HandleCoreAsync(IRequestInput input, MyTelegram.Schema.Messages.RequestCheckHistoryImport obj)
    {
