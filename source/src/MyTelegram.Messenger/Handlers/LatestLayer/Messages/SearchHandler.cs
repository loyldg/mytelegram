...
/// </remarks>
internal sealed class SearchHandler(IMessageAppService messageAppService,
    ITokenizer tokenizer,
    IPeerHelper peerHelper, IAccessHashHelper accessHashHelper, IGetHistoryConverterService getHistoryConverterService) : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestSearch, IMessages>
{
