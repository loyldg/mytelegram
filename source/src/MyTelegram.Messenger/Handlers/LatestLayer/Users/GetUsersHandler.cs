...
/// </remarks>
internal sealed class GetUsersHandler(IAccessHashHelper accessHashHelper, IUserConverterService userConverterService)
        ...
        foreach (var inputUser in obj.Id)
        {
            switch (inputUser)
            {
                case TInputUser inputUser1:
                    ...
                    result.Add(new TUserEmpty
                    {
                        Id = inputUser1.UserId
                    });
                    break;
