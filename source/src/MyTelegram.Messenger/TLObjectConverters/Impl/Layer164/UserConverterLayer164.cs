...
public class UserConverterLayer164 : UserConverterBase, IUserConverterLayer164
{
    ...
    public UserConverterLayer164(IObjectMapper objectMapper,
    ...
    protected virtual void SetContactPersonalProfilePhoto(IContactReadModel? contactReadModel, ILayeredUser layeredUser, IReadOnlyCollection<IPhotoReadModel>? photos, MyTelegram.Schema.IUserFull? userFull = null)
    {
    ...
    protected virtual void CallAfterUserFullCreated(IUserReadModel user, ILayeredUser layeredUser, MyTelegram.Schema.IUserFull userFull)
    {
    ...
    {
        var user = ToUser(userReadModel.UserId, userReadModel, photoReadModel == null ? null : new List<IPhotoReadModel> { photoReadModel });
