...
public class MessageConverterLayer164 : LayeredConverterBase, IMessageConverterLayer164
{
    ...
    public MessageConverterLayer164(IPeerHelper peerHelper,
        ...
        switch (readModel.SendMessageType)
        {
            case SendMessageType.MessageService:
            {
                ...
                var m = new TMessageService
                {
                    ...
                    Action = bytes.ToTObject<IMessageAction>(),
                    ReplyTo = ToMessageReplyHeader(readModel.ReplyToMsgId, readModel.TopMsgId)
                };
