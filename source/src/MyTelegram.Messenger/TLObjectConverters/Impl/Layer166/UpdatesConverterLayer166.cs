...
public class UpdatesConverterLayer166 : LayeredConverterBase, IUpdatesConverterLayer166
{
    ...
    public UpdatesConverterLayer166(
    ...
    public IUpdates ToMigrateChatUpdates(SendOutboxMessageCompletedEvent aggregateEvent, IChannelReadModel channelReadModel, IChatReadModel chatReadModel)
    {
        // send from chat
        var m = aggregateEvent.MessageItem;
        ...
        var updates = new TUpdates
        {
            Updates = new TVector<IUpdate>(updateChannel, updateNotifySettings, updateReadChannelInbox, updateNewChannelMessage,
                updateNewMessage,
    ...
    public IUpdates ToChannelUpdates(long selfUserId, IChannelReadModel channelReadModel, IPhotoReadModel? photoReadModel)
    {
        ...
        bool createUpdatesForSelf)
    {
        ...
        {
            updateList.AddRange(startInviteToChannelEvent.PrivacyRestrictedUserId.Select(p => new TUpdateGroupInvitePrivacyForbidden
            {
                UserId = p
            }));
        }
