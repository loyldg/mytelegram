...
public class AuthorizationConverterLayer166 : IAuthorizationConverter
{
    private readonly IObjectMapper _objectMapper;
    private readonly IRandomHelper _randomHelper;

    public AuthorizationConverterLayer166(IRandomHelper randomHelper,
    ...
    public virtual Schema.IWebAuthorization ToWebAuthorization(IDeviceReadModel deviceReadModel)
    {
    ...
    public virtual IReadOnlyList<Schema.IWebAuthorization> ToWebAuthorizations(
        IReadOnlyCollection<IDeviceReadModel> deviceList,
        long selfPermAuthKeyId)
    {
        var authList = new List<Schema.IWebAuthorization>();
        foreach (var deviceReadModel in deviceList)
        {
    ...
    private Schema.IWebAuthorization ToWebAuthorization(IDeviceReadModel deviceReadModel,
        long selfPermAuthKeyId)
    {
        var auth = _objectMapper.Map<IDeviceReadModel, Schema.TWebAuthorization>(deviceReadModel);
        //auth.AppName = deviceReadModel.LangPack;
        //auth.Country = "TestCountry";
